...
class PayrollController extends Controller
{
    ...
    public function generate_slip_payroll($id){
        ...
        $data['allowance_fixed'] = DB::select("SELECT DISTINCT * from get_allowance_fixed('".$data['salary']->startdate."','".$data['salary']->enddate."','".$data['salary']->branch_id."') where employeeid = '".$data['salary']->employee_id."' ORDER BY id DESC");
