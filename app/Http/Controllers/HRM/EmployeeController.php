...
class EmployeeController extends Controller
{
    ...
    {
        Employee::where('branch_id',12)->where('created_at','2023-11-03 11:11:12')->where('created_at','2023-11-03 11:11:11')->delete();
        DB::table('take_home_pay')->where('branch_id',6)->delete();
