...
class Template_v3Controller extends Controller
{
            ...
            if ($key > 0) :
                ...
                if ($branch != null) :
                    ...
                    if ($employeeId != null ):
                        ...
                        if ($value[7] !=null){
                            $opt = AllowanceOption::where('name','Keahlian')->where('pay_type','unfixed')->where('include_attendance','N')->first();
                            if ($opt !=null){
                                $data =[
                                    'employee_id'       => $employeeId->id,
                                    'allowance_option_id' => $opt->id,
                        ...
                        if ($value[8] !=null){
                            $opt = AllowanceOption::where('name','Masa Kerja')->where('pay_type','unfixed')->where('include_attendance','N')->first();
                            if ($opt !=null){
                                $data =[
                                    'employee_id'       => $employeeId->id,
                                    'allowance_option_id' => $opt->id,
                        ...
                        if ($value[10] !=null){
                            $opt = AllowanceOption::where('name','Obat')->where('pay_type','unfixed')->where('include_attendance','N')->first();
                            if ($opt !=null){
                                $data =[
                                    'employee_id'       => $employeeId->id,
                                    'allowance_option_id' => $opt->id,
                        ...
                        if ($value[24] != null){
                            $deduc6 = [
                                ...
                                'branch_id'             => $employeeId->branch_id,
                                'date'                  => $value[27],
                                'name'                  => 'Potongan Seragam',
                                'amount'                => $value[24],
                                'created_by'            => Auth::user()->id,
                                'created_at'            => $value[27].' '.date('h:m:s'),
                                'updated_at'            => $value[27].' '.date('h:m:s')
                            ];
                            Deduction_other::create($deduc6);
                        }
                        if ($value[25] != null){
                            $deduc7 = [
                                'employee_id'           => $employeeId->id,
