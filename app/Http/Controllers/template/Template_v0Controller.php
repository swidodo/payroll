...
class Template_v0Controller extends Controller
{
            ...
            if ($key > 0) :
                ...
                if ($branch != null) :
                    ...
                    if ($employeeId != null ):
                        ...
                        $deduction_other  = (($value[13] !=null) ? $value[13] : 0 ) + 
                        ...
                        if ($value[21] != null){
                            $deduc4 = [
                                ...
                                'branch_id'             => $employeeId->branch_id,
                                'date'                  => $value[24],
                                'name'                  => 'Potongan kelebihan gaji/Koreksi -',
                                'amount'                => $value[21],
                                'created_by'            => Auth::user()->id,
                                'created_at'            => $value[24].' '.date('h:m:s'),
                                'updated_at'            => $value[24].' '.date('h:m:s')
