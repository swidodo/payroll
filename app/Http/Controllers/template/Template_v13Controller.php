...
// basic salary utuh, uang makan utuh, overtime utuh
class Template_v13Controller extends Controller
{
            ...
            if ($key > 0) :
                ...
                if ($branch != null) :
                    ...
                    if ($employeeId != null ):
                        ...
                        $deduction_other  = (($value[19] !=null) ? $value[19] : 0 ) + (($value[20] !=null) ? $value[20] : 0 ) + (($value[21] !=null) ? $value[21] : 0 ) + (($value[22] !=null) ? $value[22] : 0 ) + (($value[23] !=null) ? $value[23] : 0 );
                        $bpjs             = (($value[18] !=null) ? $value[18] : 0 ) + (($value[16] !=null) ? $value[16] : 0 ) + (($value[17] !=null) ? $value[17] : 0 );
                        ...
                        $datas = [
                            ...
                            'employee_pay_bpjs_kesehatan'       => (($value[17] !=null) ? $value[17] : 0 ),
                            ...
                            'total_overtime_hour_holiday'       => (($value[13] !=null) ? $value[13] : 0),
                            'rapel'                             => $rapel,
                        ...
                        if ($value[10] !=null){
                            $opt = AllowanceOption::where('name','Tunjangan')->where('pay_type','unfixed')->where('include_attendance','N')->first();
                            if ($opt !=null){
                                $data =[
                                    'employee_id'       => $employeeId->id,
                                    'allowance_option_id' => $opt->id,
