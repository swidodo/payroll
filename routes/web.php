...
use App\Http\Controllers\Report\ReportSalaryController;
...
Route::group(['middleware' => 'auth'], function () {
        ...
        Route::get('reporting-salary',[ReportSalaryController::class,'index'])->name('reporting-salary');
        Route::get('get-reporting-salary',[ReportSalaryController::class,'get_data'])->name('get-reporting-salary');
});
