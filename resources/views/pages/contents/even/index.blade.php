        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                <div class="col-auto float-end ms-auto">
                    <a href="{{ route('create-even')}}" class="btn add-btn" ><i class="fa fa-plus"></i>Even</a>
                </div>
                @can('create even')
                @endcan
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="table-responsive">
                    <table class="table table-striped custom-table" id="table-even">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Date</th>
...
@push('addon-script')
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click','.edit-even',function(e){
                e.preventDefault()
                var id = $(this).attr('data-id')
                window.location.href = 'edit-even/'+id;
                
            })
            $(document).on('click','.publish-even',function(e){
                e.preventDefault()
                var id = $(this).attr('data-id')
                var branch_id = $('#branch_id').val();
                Swal.fire({
