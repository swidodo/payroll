                    ...
                    success : function(respon){
                        ...
                        bpjs += ` <div class="col-md-6">
                                        <div class="form-check col-md-6 mb-3">
                                            <input class="form-check-input itemBpjs editItemBpjs" data-id="`+val.id+`" data-code = "`+val.code+`" data-empId ="`+respon.payroll.employee_id+`" type="checkbox" name="bpjs[]" value="`+val.id+`" id="flexCheckDefault" `+checked+`>
