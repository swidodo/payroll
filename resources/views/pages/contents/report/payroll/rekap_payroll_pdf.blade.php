...
<table class="table table-bordered" width="100%">
    ...
    <tbody>
        ...
        @endforeach
        <tr><td  colspan="19" class="border-top border-right border-left border-bottom">Total</td><td class="border-top border-left border-right border-bottom" align="right">{{ number_format($total->total) }}</td></tr>
