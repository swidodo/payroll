                    ...
                    <h4>Document Detail</h4>
                        ...
                        <div class="col-md-6">
                            <div class="info text-sm">
                                ...
                                <span><a href="{{ (!empty($employeedoc[$document->id]) ? 'storage/app/public/uploads/document/'.$employeedoc[$document->id]:'') }}" target="_blank">{{ (!empty($employeedoc[$document->id])?$employeedoc[$document->id]:'') }}</a></span>
                            </div>
                        </div>
                        @endforeach
                        @else
