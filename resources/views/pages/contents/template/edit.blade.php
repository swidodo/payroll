                                ...
                                @for ($i=1;$i<=20;$i++)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            @if ($data->versi == "V".$i)
                                                <input class="form-check-input template-input" type="radio" name="template" value="V{{$i}}" checked>
                                            @else
                                                <input class="form-check-input template-input" type="radio" name="template" value="V{{$i}}">
                                            @endif
                                        </td>
                                    </tr>
                                @endfor
