            ...
            <div class="row align-items-center">
                ...
                @can('create allowance')
                    <div class="col-auto float-end ms-auto">
                        <a href="{{route('setting-payroll-overtime.create')}}" class="btn add-btn"><i class="fa fa-plus"></i> New</a>
                    </div>
                @endcan
            </div>
        </div>
                    ...
                    <table class="table table-striped custom-table datatable">
                        <thead>
                            <tr>
                                ...
                                <th>Hour</th>
                                <th>Amount</th>
                                @if(Auth::user()->can('edit setting payroll overtime') || Auth::user()->can('delete setting payroll overtime'))
