                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                ...
                                <div class="tab-pane fade" id="pills-hrmpermission" role="tabpanel" aria-labelledby="pills-hrmpermission-tab">
                                    @php
                                        $modules=['attendance', 'leave', 'overtime', 'request shift schedule', 'shift schedule', 'reimbursement option', 'branch', 'leave type', 'performance review', 'loan option', 'denda', 'bpjs kesehatan', 'allowance option', 'payslip', 'payslip type', 'day type', 'overtime type', 'shift type', 'on duty', 'timesheet', 'payroll', 'payslip code pin','rotation','request employees','other allowance','thr','group position','position'];
                                        // $modules=['hrm dashboard','employee','employee profile','department','designation','branch','document type','document','payslip type','allowance','commission','allowance option','loan option','deduction option','loan','saturation deduction','other payment','overtime','set salary','pay slip','company policy','appraisal','goal tracking','goal type','indicator','event','meeting','training','trainer','training type','award','award type','resignation','travel','promotion','complaint','warning','termination','termination type','job application','job application note','job onBoard','job category','job','job stage','custom question','interview schedule','estimation','holiday','transfer','announcement','leave','leave type','attendance','rotation','request employees','other allowance','thr'];
                                    @endphp
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                ...
                                <div class="tab-pane fade" id="pills-hrmpermissions" role="tabpanel" aria-labelledby="pills-hrmpermissions-tab">
                                    @php
                                        $modules=['attendance', 'leave', 'overtime', 'request shift schedule', 'shift schedule', 'reimbursement option', 'branch', 'leave type', 'performance review', 'loan option', 'denda', 'bpjs kesehatan', 'allowance option', 'payslip', 'payslip type', 'day type', 'overtime type', 'shift type', 'on duty', 'timesheet', 'payroll', 'payslip code pin','rotation','request','request employees','other allowance','thr'];
