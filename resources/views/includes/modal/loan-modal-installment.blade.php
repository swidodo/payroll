                    ...
                    <form action="{{route('loans.store')}}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <input type="hidden" name="loan" value="installment">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" placeholder="tenor" name="tenor"  id="tenor">

                                        @if ($errors->has('tenor'))
                                            <div class="text-danger" role="alert">
                                                <small><strong>{{ $errors->get('tenor')[0] }}</strong></small>
                                            </div>
                                        @endif
                                </div>
                    ...
                    <form action="" id="edit-form-loan" method="POST">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <label for="installment" class="form-label">Tenor</label>
                                <div class="input-group mb-3">
                                    <input type="number" class="form-control" placeholder="tenor" name="tenor"  id="tenor-edit">
                                        @if ($errors->has('installment'))
                                            <div class="text-danger" role="alert">
                                                <small><strong>{{ $errors->get('tenor')[0] }}</strong></small>
                                            </div>
