    <!-- Add overtime Modal -->
    <div id="add_cash" class="modal custom-modal fade" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Create New Cash Advance</h5>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="loan_type_id" id="loan_type_id" class="form-control select-cash-type">
                                        <option value="0">Select Cash Advance Type</option>
    ...
    <!-- Edit Overtime Modal -->
    <div id="edit_cash" class="modal custom-modal fade" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form action="" id="edit-form-cash" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <label for="loan_type_id" class="form-label">Loan Type</label>
                                    <select name="loan_type_id" id="loan_type_id_edit" class="form-control select-cash-type">
                                        <option value="0">Select Cash Advance Type</option>
                                        @foreach ($loanType as $type)
                                        <option value="{{$type->id}}">{{$type->name}}</option>
                                        @endforeach
    ...
    <!-- Delete User Modal -->
    <div class="modal custom-modal fade" id="delete_cash" role="dialog">
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="modal-btn delete-action">
                        <div class="row">
                            <div class="col-6">
                                <form action="" id="form-delete-cash" method="POST">
                                    @csrf
                                    @method('DELETE')
