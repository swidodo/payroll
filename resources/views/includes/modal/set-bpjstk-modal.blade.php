<!-- Add  Modal -->
<div id="add_set_bpjstk" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">New Set BPJS TK</h5>
                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="{{route('set-bpjstk.store')}}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-sm-12">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="col-md-3 custom-control custom-checkbox">
                                                                    <input class="form-check-input isscheck staff_checkall isscheck_" type="checkbox" name="bpjstk[]" value="{{$module}}" id="">
                                                                </div>
                                                            </td>
...
<!-- Edit User Modal -->
<div id="edit_set_bpjstk" class="modal custom-modal fade" role="dialog">≈
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form id="edit-form-set-bpjstk" action="" method="POST">
                    @method('PUT')
                    @csrf
                    <div class="row">
                        <div class="col-sm-12">
                                            ...
                                            @foreach ($modules as $module)
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <div class="col-md-3 custom-control custom-checkbox">
                                                                    <input class="form-check-input isscheck staff_checkall isscheck_" type="checkbox" name="bpjstk[]" value="{{$module}}" id="bpjstk_edit{{$module}}">
                                                                </div>
                                                            </td>
                                                            <td><label class="ischeck staff_checkall" data-id="{{str_replace(' ', '', str_replace('&', '', $module))}}">{{ ucfirst($module) }}</label></td>
                                                        </tr>
...
<!-- /Edit User Modal -->
 ...
 <!-- Delete User Modal -->
 <div class="modal custom-modal fade" id="delete_set_bpjstk" role="dialog">
