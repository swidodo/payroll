                        ...
                        <ul style="display: none;">
                            ...
                            @canany(['manage performance review', 'create performance review', 'edit performance review', 'delete performance review'])
                                <li class="submenu {{(request()->routeIs('performance-review*')) ? 'active' : ''}}" >
                                    <a style="padding: 9px 10px 9px 50px" href="#"> <span> Performance</span> <span class="menu-arrow"></span></a>
                                    <ul style="display: none;">

                                        @canany(['manage performance review', 'create performance review', 'edit performance review', 'delete performance review'])
                                            <li class="{{(request()->routeIs('performance-review*')) ? 'active' : ''}}"><a class="{{(request()->routeIs('performance-review*')) ? 'active' : ''}}" href="{{ route('performance-review.index') }}">Review</a></li>
                                        @endcanany
                ...
                @canany(['manage user',
                    ...
                    <li class="submenu">
                        ...
                        @canany(['manage user', 'create user'])
                            <li class="{{(request()->routeIs('reporting-attandance')) ? 'active' : ''}}"><a class="{{(request()->routeIs('reporting-attandance')) ? 'active' : ''}}" href="{{ route('reporting-attandance') }}">Attandance</a></li>
                        @endcanany
                        @canany(['manage user', 'create user'])
                            <li class="{{(request()->routeIs('reporting-salary')) ? 'active' : ''}}"><a class="{{(request()->routeIs('reporting-salary')) ? 'active' : ''}}" href="{{ route('reporting-salary') }}">Salary</a></li>
                        @endcanany
                    ...
                    <li class="submenu">
                        ...
                        <ul style="display: none;">
                            ...
                            @canany(['manage level approval', 'edit level approval'])
                                <li class="{{(request()->routeIs('level-approvals*')) ? 'active' : ''}}"><a class="{{(request()->routeIs('level-approvals*')) ? 'active' : ''}}" href="{{ route('level-approvals.index') }}">Approval </a></li>
                            @endcanany
