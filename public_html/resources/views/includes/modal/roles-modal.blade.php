                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                ...
                                <div class="tab-pane fade" id="pills-hrmpermission" role="tabpanel" aria-labelledby="pills-hrmpermission-tab">
                                    @php
                                        $modules=['attendance', 'leave', 'overtime', 'request shift schedule', 'shift schedule', 'reimbursement option', 'branch', 'leave type', 'performance review', 'loan option', 'denda', 'bpjs kesehatan', 'allowance option', 'payslip', 'payslip type', 'day type', 'overtime type', 'shift type', 'on duty', 'timesheet', 'payroll', 'payslip code pin'];
